...
<iframe src="../maps/adm_ons_lsoa_boundary_2011.html" title="Interactive preview map of adm_ons_lsoa_boundary_2011" loading="lazy" style="width:100%;height:480px;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;"></iframe>

<a href="../maps/adm_ons_lsoa_boundary_2011.html" target="_blank" rel="noopener">Open the map in a new tab &#8599;</a>
...
- "Full resolution - clipped to the coastline (Mean High Water mark)." (ONS digitalboundaries page, definition of BFC)
