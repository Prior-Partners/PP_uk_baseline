...
- Counts only; uk044001 is the table total. No percentages are supplied by the publisher and none were computed.
...
| `uk044001` | `integer` | Source field `uk044001`; "Accommodation type: Total: All households". Unit: "Household". |
| `uk044002` | `integer` | Source field `uk044002`; "Accommodation type: Detached". Unit: "Household". |
| `uk044003` | `integer` | Source field `uk044003`; "Accommodation type: Semi-detached". Unit: "Household". |
| `uk044004` | `integer` | Source field `uk044004`; "Accommodation type: Terraced". Unit: "Household". |
| `uk044005` | `integer` | Source field `uk044005`; "Accommodation type: In a purpose-built block of flats or tenement". Unit: "Household". |
| `uk044006` | `integer` | Source field `uk044006`; "Accommodation type: Part of a converted or shared house, including bedsits". Unit: "Household". |
| `uk044007` | `integer` | Source field `uk044007`; "Accommodation type: In a commercial building, for example, in an office building, hotel or over a shop". Unit: "Household". |
| `uk044008` | `integer` | Source field `uk044008`; "Accommodation type: A caravan or other mobile or temporary structure". Unit: "Household". |
