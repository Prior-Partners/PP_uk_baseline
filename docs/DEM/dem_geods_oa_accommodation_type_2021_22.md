# Geographic Data Service (GeoDS) Unified UK Census 2021/2022, Accommodation type, United Kingdom small-area extent, March 2026

<p class="layer-short">Census 2021/22 Accommodation type (UK)</p>

`dem_geods_oa_accommodation_type_2021_22`

**SOURCE**

- Geographic Data Service (GeoDS), Smart Data Research UK. Unified UK Census Data (2021/2), topic table uk044 from variable_tables_csv.zip (published 19 February 2026, last modified 3 March 2026). Harmonised by GeoDS from Office for National Statistics (ONS), National Records of Scotland (NRS) and Northern Ireland Statistics and Research Agency (NISRA) census outputs. All 8 source columns copied as published; nothing derived or filtered. Columns carry readable names from the GeoDS labels (see SCOPE); the GeoDS identifier is recorded in every column comment.
...
- Counts only; `total` (GeoDS uk044001) is the table total. No percentages are supplied by the publisher and none were computed.
...
- Harmonisation notes for this table (GeoDS Table Notes, verbatim): "1. The table for England and Wales includes an additional variable not included in the other nations' tables: "Part of another converted building, for example, former school, church or warehouse". This is combined into the variable "Part of a converted or shared house, including bedsits" in the unified table."
...
| `total` | `integer` | Source field `uk044001`; "Accommodation type: Total: All households". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `detached` | `integer` | Source field `uk044002`; "Accommodation type: Detached". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `semi_detached` | `integer` | Source field `uk044003`; "Accommodation type: Semi-detached". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `terraced` | `integer` | Source field `uk044004`; "Accommodation type: Terraced". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `purpose_built_flat_or_tenement` | `integer` | Source field `uk044005`; "Accommodation type: In a purpose-built block of flats or tenement". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `converted_or_shared_house` | `integer` | Source field `uk044006`; "Accommodation type: Part of a converted or shared house, including bedsits". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `commercial_building` | `integer` | Source field `uk044007`; "Accommodation type: In a commercial building, for example, in an office building, hotel or over a shop". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `caravan_or_temporary_structure` | `integer` | Source field `uk044008`; "Accommodation type: A caravan or other mobile or temporary structure". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
