...
<p class="layer-short">Census 2021 Number of cars or vans (UK)</p>

`dem_geods_oa_cars_vans_2021`
...
- Counts only; uk045001 is the table total. No percentages are supplied by the publisher and none were computed.
...
| `uk045001` | `integer` | Source field `uk045001`; "Number of cars or vans: Total: All households". Unit: "Household". |
| `uk045002` | `integer` | Source field `uk045002`; "Number of cars or vans: No cars or vans in household". Unit: "Household". |
| `uk045003` | `integer` | Source field `uk045003`; "Number of cars or vans: 1 car or van in household". Unit: "Household". |
| `uk045004` | `integer` | Source field `uk045004`; "Number of cars or vans: 2 cars or vans in household". Unit: "Household". |
| `uk045005` | `integer` | Source field `uk045005`; "Number of cars or vans: 3 or more cars or vans in household". Unit: "Household". |
