...
<p class="layer-short">Census 2021/22 Disability (UK)</p>

`dem_geods_oa_disability_2021_22`
...
- Counts only; `total` (GeoDS uk038001) is the table total. No percentages are supplied by the publisher and none were computed.
...
| `total` | `integer` | Source field `uk038001`; "Disability: Total: All usual residents". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `disabled` | `integer` | Source field `uk038002`; "Disability: Disabled under the Equality Act". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `disabled_limited_a_lot` | `integer` | Source field `uk038003`; "Disability: Disabled under the Equality Act: Day-to-day activities limited a lot". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `disabled_limited_a_little` | `integer` | Source field `uk038004`; "Disability: Disabled under the Equality Act: Day-to-day activities limited a little". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `not_disabled` | `integer` | Source field `uk038005`; "Disability: Not disabled under the Equality Act". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
