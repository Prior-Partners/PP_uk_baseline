# Geographic Data Service (GeoDS) Unified UK Census 2021/2022, Proficiency in English language, United Kingdom small-area extent, March 2026

<p class="layer-short">Census 2021/22 Proficiency in English language (UK)</p>

`dem_geods_oa_english_proficiency_2021_22`

**SOURCE**

- Geographic Data Service (GeoDS), Smart Data Research UK. Unified UK Census Data (2021/2), topic table uk029 from variable_tables_csv.zip (published 19 February 2026, last modified 3 March 2026). Harmonised by GeoDS from Office for National Statistics (ONS), National Records of Scotland (NRS) and Northern Ireland Statistics and Research Agency (NISRA) census outputs. All 3 source columns copied as published; nothing derived or filtered. Columns carry readable names from the GeoDS labels (see SCOPE); the GeoDS identifier is recorded in every column comment.
...
- Table unit: "Person". Population scope: "Persons Aged 3 or Over". (GeoDS Table Notes)
...
- Counts only; `total` (GeoDS uk029001) is the table total. No percentages are supplied by the publisher and none were computed.
...
- Harmonisation notes for this table (GeoDS Table Notes, verbatim): "1. To create compatible variables two new variables are created from separate aggregations of the census variables. "Speaks English Very well or well" and "Cannot speak English well or at all". This follows the approach in the UK OAC. 2. This is necessary as Scotland asked additional questions regarding language skills beyond speaking (Reading, Writing, and Understanding). Their table therefore does not include the full subdivisions for proficiency of speaking present in the other nations' tables."
...
| `total` | `integer` | Source field `uk029001`; "Proficiency in English language: Total: All usual residents aged 3 years and over". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `speaks_english_well` | `integer` | Source field `uk029002`; "Proficiency in English language: Speaks English very well or well". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `cannot_speak_english_well` | `integer` | Source field `uk029003`; "Proficiency in English language: Cannot speak English well or at all". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
