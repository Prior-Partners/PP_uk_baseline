...
- Counts only; uk029001 is the table total. No percentages are supplied by the publisher and none were computed.
...
| `uk029001` | `integer` | Source field `uk029001`; "Proficiency in English language: Total: All usual residents aged 3 years and over". Unit: "Person". |
| `uk029002` | `integer` | Source field `uk029002`; "Proficiency in English language: Speaks English very well or well". Unit: "Person". |
| `uk029003` | `integer` | Source field `uk029003`; "Proficiency in English language: Cannot speak English well or at all". Unit: "Person". |
