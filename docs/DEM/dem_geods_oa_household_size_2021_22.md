...
- Counts only; uk017001 is the table total. No percentages are supplied by the publisher and none were computed.
...
| `uk017001` | `integer` | Source field `uk017001`; "Household size: Total: All household spaces". Unit: "Household". |
| `uk017002` | `integer` | Source field `uk017002`; "Household size: 1 person in household". Unit: "Household". |
| `uk017003` | `integer` | Source field `uk017003`; "Household size: 2 people in household". Unit: "Household". |
| `uk017004` | `integer` | Source field `uk017004`; "Household size: 3 people in household". Unit: "Household". |
| `uk017005` | `integer` | Source field `uk017005`; "Household size: 4 people in household". Unit: "Household". |
| `uk017006` | `integer` | Source field `uk017006`; "Household size: 5 or more people in household". Unit: "Household". |
