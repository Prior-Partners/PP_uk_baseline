# Geographic Data Service (GeoDS) Unified UK Census 2021/2022, Household size, United Kingdom small-area extent, March 2026

<p class="layer-short">Census 2021/22 Household size (UK)</p>

`dem_geods_oa_household_size_2021_22`

**SOURCE**

- Geographic Data Service (GeoDS), Smart Data Research UK. Unified UK Census Data (2021/2), topic table uk017 from variable_tables_csv.zip (published 19 February 2026, last modified 3 March 2026). Harmonised by GeoDS from Office for National Statistics (ONS), National Records of Scotland (NRS) and Northern Ireland Statistics and Research Agency (NISRA) census outputs. All 6 source columns copied as published; nothing derived or filtered. Columns carry readable names from the GeoDS labels (see SCOPE); the GeoDS identifier is recorded in every column comment.
...
- Counts only; `total` (GeoDS uk017001) is the table total. No percentages are supplied by the publisher and none were computed.
...
- Harmonisation notes for this table (GeoDS Table Notes, verbatim): "1. The denominator for the England and Wales table is technically different between from Scotland, it is describes as "All houseshold spaces"  rather than  "All occupied household spaces". There is an additional variable "Household size: 0 people in household" but this has zero counts for all OAs. Therefore the tables are fully equivalent."
...
| `total` | `integer` | Source field `uk017001`; "Household size: Total: All household spaces". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `one` | `integer` | Source field `uk017002`; "Household size: 1 person in household". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `two` | `integer` | Source field `uk017003`; "Household size: 2 people in household". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `three` | `integer` | Source field `uk017004`; "Household size: 3 people in household". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `four` | `integer` | Source field `uk017005`; "Household size: 4 people in household". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `five_plus` | `integer` | Source field `uk017006`; "Household size: 5 or more people in household". Unit: "Household". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
