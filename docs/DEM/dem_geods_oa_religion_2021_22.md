...
- Counts only; `total` (GeoDS uk030001) is the table total. No percentages are supplied by the publisher and none were computed.
...
| `total` | `integer` | Source field `uk030001`; "Religion: Total: All usual residents". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `no_religion` | `integer` | Source field `uk030002`; "Religion: No religion". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `christian` | `integer` | Source field `uk030003`; "Religion: Christian". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `hindu` | `integer` | Source field `uk030004`; "Religion: Hindu". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `muslim` | `integer` | Source field `uk030005`; "Religion: Muslim". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `other_religion` | `integer` | Source field `uk030006`; "Religion: Other religion (NI 6 categories defintion)". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `not_answered` | `integer` | Source field `uk030007`; "Religion: Not answered". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
