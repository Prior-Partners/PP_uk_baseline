...
- Counts only; uk001001 is the table total. No percentages are supplied by the publisher and none were computed.
...
| `uk001001` | `integer` | Source field `uk001001`; "Residence type: Total". Unit: "Person". |
| `uk001002` | `integer` | Source field `uk001002`; "Residence type: Lives in a household". Unit: "Person". |
| `uk001003` | `integer` | Source field `uk001003`; "Residence type: Lives in a communal establishment". Unit: "Person". |
