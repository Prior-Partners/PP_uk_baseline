...
- Counts only; `total` (GeoDS uk001001) is the table total. No percentages are supplied by the publisher and none were computed.
...
| `total` | `integer` | Source field `uk001001`; "Residence type: Total". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `lives_in_household` | `integer` | Source field `uk001002`; "Residence type: Lives in a household". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
| `lives_in_communal_establishment` | `integer` | Source field `uk001003`; "Residence type: Lives in a communal establishment". Unit: "Person". Column renamed from the GeoDS identifier on 2 September 2026 (data manager sign-off). |
