# Geographic Data Service (GeoDS) Unified UK Census 2021/2022, Provision of unpaid care, United Kingdom small-area extent, March 2026

<p class="layer-short">Census 2021/22 Provision of unpaid care (UK)</p>

`dem_geods_oa_unpaid_care_2021_22`
...
- Table unit: "Person". Population scope: "Persons Age d5 or Over (Aged 3 or Over for Scotland)". (GeoDS Table Notes)
...
- Harmonisation notes for this table (GeoDS Table Notes, verbatim): "1. The English and Scottish tables differ slightly, England only includes those aged over five in the table, whereas Scotland includes those over three."
