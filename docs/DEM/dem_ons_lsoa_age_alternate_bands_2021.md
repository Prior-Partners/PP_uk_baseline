...
<p class="layer-short">Census 2021 Age Alternate Bands</p>

`dem_ons_lsoa_age_alternate_bands_2021`

<img src="../../maps/dem_ons_lsoa_age_alternate_bands_2021.png" alt="Styling preview of dem_ons_lsoa_age_alternate_bands_2021" loading="lazy" style="width:100%;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;">
