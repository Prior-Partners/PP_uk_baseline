# ONS Business Register and Employment Survey (BRES) employment counts for 2024 at Local Authority District (LAD), broken down by 2-digit SIC2007 industry division

`ecn_ons_lad_business_register_employment_2d_2024`

<img src="../../maps/ecn_ons_lad_business_register_employment_2d_2024.png" alt="Styling preview of ecn_ons_lad_business_register_employment_2d_2024" loading="lazy" style="width:100%;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;">

<a href="http://localhost:7800/?layer=uk_baseline.ecn_ons_lad_business_register_employment_2d_2024" target="_blank" rel="noopener">Open in the Dashboard &#8599;</a> <span style="opacity:.6;font-size:.85em;">(start your local Dashboard first)</span>
...
- England and Wales. Local Authority District as of April 2021; 331 rows (309 England + 22 Wales) after post-load Scotland filter. Filter applied at download: EMPLOYMENT_STATUS=4 (Employment), MEASURE=1 (Count), MEASURES=20100 (Value); reference date 1 January 2024.
...
- LAD edition: BRES ships LAD codes as of April 2021 (`lad21cd`). The geometry is joined from uk_baseline.adm_ons_lad_boundary_may2022 which carries `lad22cd`; values match 1:1 for the 331 E&W LADs after Scotland is removed.
...
|---|---|---|
| `fid` | `integer` |  |
| `lad21cd` | `character varying(20)` | Source field `GEOGRAPHY_CODE`. |
| `lad21nm` | `character varying(255)` | Source field `GEOGRAPHY_NAME`. |
