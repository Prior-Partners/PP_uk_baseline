# ONS Business Register and Employment Survey (BRES) employment by 18 broad industry groups at Local Authority District, Prior + Partners edition, 2024

<p class="layer-short">BRES Employment - LAD, 2024, broad groups (P+P)</p>

`ecn_ons_lad_business_register_employment_pp_2024`
...
- England and Wales. Districts as of April 2023; 318 rows. Survey year 2024.
...
|---|---|---|
| `ladcd` | `character varying(9)` | Source field `GEOGRAPHY_CODE`; Local Authority District as of April 2023 (same district set as 2025; Barnsley and Sheffield carry their pre-2025 codes). |
| `ladnm` | `character varying(60)` | Source field `GEOGRAPHY_NAME`. |
