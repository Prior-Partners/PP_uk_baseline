...
<p class="layer-short">BRES Employment - LSOA, 2024, 2D</p>

`ecn_ons_lsoa_business_register_employment_2d_2024`

<img src="../../maps/ecn_ons_lsoa_business_register_employment_2d_2024.png" alt="Styling preview of ecn_ons_lsoa_business_register_employment_2d_2024" loading="lazy" style="width:100%;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;">
