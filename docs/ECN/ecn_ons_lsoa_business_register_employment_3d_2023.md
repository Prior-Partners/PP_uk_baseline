# ONS Business Register and Employment Survey (BRES) employment counts for 2023 at Lower Layer Super Output Area (LSOA), broken down by 3-digit SIC2007 industry group

`ecn_ons_lsoa_business_register_employment_3d_2023`

<img src="../../maps/ecn_ons_lsoa_business_register_employment_3d_2023.png" alt="Styling preview of ecn_ons_lsoa_business_register_employment_3d_2023" loading="lazy" style="width:100%;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;">

<a href="http://localhost:7800/?layer=uk_baseline.ecn_ons_lsoa_business_register_employment_3d_2023" target="_blank" rel="noopener">Open in the Dashboard &#8599;</a> <span style="opacity:.6;font-size:.85em;">(start your local Dashboard first)</span>
...
- England and Wales. Lower Layer Super Output Area (LSOA) 2021; 35,672 rows. Filter applied at download: EMPLOYMENT_STATUS=4 (Employment), MEASURE=1 (Count), MEASURES=20100 (Value); reference date 1 January 2023.
