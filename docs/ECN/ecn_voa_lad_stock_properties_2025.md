...
<img src="../../maps/ecn_voa_lad_stock_properties_2025.png" alt="Styling preview of ecn_voa_lad_stock_properties_2025" loading="lazy" style="width:100%;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;">

<a href="http://localhost:7800/?layer=uk_baseline.ecn_voa_lad_stock_properties_2025" target="_blank" rel="noopener">Open in the Dashboard &#8599;</a> <span style="opacity:.6;font-size:.85em;">(start your local Dashboard first)</span>
...
- Local Authority District (LAD) May 2024 boundaries, England and Wales. 318 rows (E: 296; W: 22). Source CSV rows filtered to geography = 'LAUA'.
...
|---|---|---|
| `fid` | `integer` |  |
| `lad24cd` | `character varying(20)` | Source field `area_code` |
| `lad24nm` | `character varying(255)` | Source field `area_name` |
| `ba_code` | `character varying(10)` | Source field `ba_code` |
