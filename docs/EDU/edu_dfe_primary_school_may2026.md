...
<iframe src="../../maps/edu_dfe_primary_school_may2026.html" title="Interactive preview map of edu_dfe_primary_school_may2026" loading="lazy" style="width:100%;height:480px;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;"></iframe>

<a href="../../maps/edu_dfe_primary_school_may2026.html" target="_blank" rel="noopener">Open the map in a new tab &#8599;</a>
...
- DfE phase classification: Primary — primary-phase school (statutory ages typically 4-11); Middle deemed primary — middle school covering an age range categorised as primary-phase under DfE's deeming rules; All-through — covers primary and secondary phases in one establishment.
