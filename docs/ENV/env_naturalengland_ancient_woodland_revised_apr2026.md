...
<a href="http://localhost:7800/?layer=uk_baseline.env_naturalengland_ancient_woodland_revised_apr2026" target="_blank" rel="noopener">Open in the Dashboard &#8599;</a> <span style="opacity:.6;font-size:.85em;">(start your local Dashboard first)</span>
