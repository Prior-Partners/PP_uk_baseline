...
- Geography keys are NULL on 49 of 1,292 rows, measured 28 July 2026: 45 fall inside an England or Wales district and could carry one, so their keys are a gap rather than an absence; 4 are residual fragments left by the MSOA split, each under 100 sqm or 10 m.
