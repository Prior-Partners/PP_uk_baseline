...
- Geography keys are NULL on 112 of 3,516 rows, measured 28 July 2026: 102 fall inside an England or Wales district and could carry one, so their keys are a gap rather than an absence; 10 are residual fragments left by the MSOA split, each under 100 sqm or 10 m.
