...
- [Natural England Country Parks for England, June 2023](env_naturalengland_country_parks_jun2023.md) · `env_naturalengland_country_parks_jun2023`
- [Natural England Environmentally Sensitive Areas (ESA) for England, June 2024](env_naturalengland_environmentally_sensitive_areas_jun2024.md) · `env_naturalengland_environmentally_sensitive_areas_jun2024`
- [Natural England Lowland Heathland Extent and Potential (England), October 2018](env_naturalengland_heathland_oct2018.md) · `env_naturalengland_heathland_oct2018`
- [Natural England Local Nature Reserves (LNR) for England, April 2026](env_naturalengland_local_nature_reserves_apr2026.md) · `env_naturalengland_local_nature_reserves_apr2026`
- [Natural England Priority Habitats Inventory (England), April 2026](env_naturalengland_priority_habitats_inventory_apr2026.md) · `env_naturalengland_priority_habitats_inventory_apr2026`
- [Natural England Ramsar sites for England, October 2024](env_naturalengland_ramsar_oct2024.md) · `env_naturalengland_ramsar_oct2024`
...
- [Ordnance Survey OS Open Greenspace for Great Britain, April 2025](env_os_green_space_apr2025.md) · `env_os_green_space_apr2025`
- [Ordnance Survey OS Open Rivers — watercourse network for Great Britain, April 2025](env_os_rivers_apr2025.md) · `env_os_rivers_apr2025`
- [Ordnance Survey OS OpenMap Local — Surface Water (inland water) for Great Britain](env_os_surface_water.md) · `env_os_surface_water`
- [Ordnance Survey OS OpenMap Local — Tidal Water for Great Britain](env_os_tidal_water.md) · `env_os_tidal_water`
- [Ordnance Survey OS OpenMap Local — Woodland for Great Britain](env_os_woodland.md) · `env_os_woodland`
- [The Rivers Trust — accessible green and blue space per 1,000 population at Middle-layer Super Output Area (MSOA), August 2024](env_rivertrust_msoa_accessible_green_blue_space_aug2024.md) · `env_rivertrust_msoa_accessible_green_blue_space_aug2024`
