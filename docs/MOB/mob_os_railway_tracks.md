...
<iframe src="../maps/mob_os_railway_tracks.html" title="Interactive preview map of mob_os_railway_tracks" loading="lazy" style="width:100%;height:480px;border:1px solid #d9d3c4;border-radius:8px;margin:6px 0 4px;"></iframe>

<a href="../maps/mob_os_railway_tracks.html" target="_blank" rel="noopener">Open the map in a new tab &#8599;</a>
