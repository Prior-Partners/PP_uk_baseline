...
- Geography keys are NULL on 285 of 3,584 rows, measured 28 July 2026: 44 fall inside an England or Wales district and could carry one, so their keys are a gap rather than an absence; 241 are in Scotland or Northern Ireland, outside the England and Wales lookup.
