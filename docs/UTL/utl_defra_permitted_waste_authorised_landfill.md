...
- Geography keys are NULL on 14 of 2,847 rows, measured 28 July 2026: 7 fall inside an England or Wales district and could carry one, so their keys are a gap rather than an absence; 7 are residual fragments left by the MSOA split, each under 100 sqm or 10 m.
